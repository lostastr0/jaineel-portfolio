...
function SkillNode({ skill, color, delay, inView }: {
  ...
  return (
    ...
    >
      <img
        ...
        width={26}
        height={26}
        style={{ objectFit: "contain", filter: hovered ? "brightness(1.2)" : "brightness(0.6)", transition: "filter 0.2s" }}
      />
      <span style={{
        fontFamily: "var(--font-dm-mono)", fontSize: 8, letterSpacing: "0.14em",
        textTransform: "uppercase", color: hovered ? color : "rgba(200,200,216,0.5)",
          ...
          {TREE.map((cat, ci) => (
            <motion.div
              ...
              style={{
                ...
                border: `1px solid ${hoveredCat === ci ? cat.color + "28" : "rgba(255,255,255,0.06)"}`,
                borderRadius: 6,
                padding: "24px",
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <span style={{
                      ...
                      boxShadow: hoveredCat === ci ? `0 0 8px ${cat.color}` : "none",
                      display: "inline-block", transition: "box-shadow 0.25s", flexShrink: 0,
                    }} />
                    <span style={{
                      fontFamily: "var(--font-syne)", fontSize: 14, fontWeight: 700,
                      color: hoveredCat === ci ? cat.color : "#efefef",
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    <span style={{ fontFamily: "var(--font-dm-mono)", fontSize: 8, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(200,200,216,0.3)" }}>
                      {cat.skills.length} tools
                    </span>
                    <span style={{ fontFamily: "var(--font-dm-mono)", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(200,200,216,0.25)" }}>·</span>
                    <span style={{ fontFamily: "var(--font-dm-mono)", fontSize: 8, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(200,200,216,0.3)" }}>
                      {cat.description}
                    </span>
                  </div>
                </div>
                {/* Summary */}
                <p style={{ fontFamily: "var(--font-dm-mono)", fontSize: 10, color: "rgba(200,200,216,0.4)", lineHeight: 1.6, letterSpacing: "0.02em", margin: 0 }}>
                  {cat.summary}
                </p>
              </div>
